...
if(isset($_POST['update'])) {	
	...
	if(empty($winkelnaam)){
		...
		$sql = "UPDATE winkels SET winkelnaam=:winkelnaam, locatie=:locatie WHERE winkelid=:winkelid";
   ...
   <div class="container-fluid">
	  <div class="row">
		...
		<div class="col-sm-9 col-lg-10 mt30">
			<form class="form-horizontal" role="form" method="post" action="wijzigwinkel.php">
				<div class="form-group">
					<label for="vak" class="col-sm-2 control-label">Winkelnaam</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="winkelnaam" name="winkelnaam" value="<?php echo $winkelnaam;?>" placeholder="" required>
					</div>
				</div>
				<div class="form-group">
