...
if(isset($_POST['submit'])) {	
	...
	if(empty($winkelnaam)|| empty($locatie)) {
		...
		$sql = "INSERT INTO winkels(winkelnaam, locatie) VALUES(:winkelnaam, :locatie)";
		
		$query = $dbConn->prepare($sql);
				
		$query->bindparam(':winkelnaam', $winkelnaam);
	...
	<div class="container-fluid">
	  <div class="row">
		...
		<div class="col-sm-9 col-lg-10 mt30">		
			<form class="form-horizontal" role="form" method="post" action="winkeltoevoegen.php">
				<div class="form-group">
					<label for="vak" class="col-sm-2 control-label">Winkelnaam</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="winkelnaam" name="winkelnaam" placeholder="" required>
					</div>
				</div>
				<div class="form-group">
					<label for="vak" class="col-sm-2 control-label">Locatie</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="locatie" name="locatie" placeholder="" required>
					</div>
				</div>
