...
<head>
	...
	<body>
		...
		?>
						...
						<p>
							<a href="winkeltoevoegen.php" class="btn btn-success">Toevoegen</a>
						</p>
						...
						<table class="table table-striped table-bordered">
							  ...
							  <?php
							   ...
							   foreach ($conn->query($sql) as $row) {
										...
										echo '<td>'. $row['winkelnaam'] . '</td>';
										echo '<td>'. $row['locatie'] . '</td>';
										echo '<td width=250>';
										echo '<a class="btn btn-success" href="wijzigwinkel.php?winkelid='.$row['winkelid'].'">Wijzigen</a>';
										echo ' ';
										echo '<a class="btn btn-danger" href="verwijderwinkel.php?winkelid='.$row['winkelid'].'">Verwijderen</a>';
										echo '</td>';
										echo '</tr>';
							   }
							   $conn = null;
